 ...
 */var n=function(){var e={tolerance:0,duration:800,easing:"easeOutQuart",container:window,callback:function(){}};function t(e,t,i,n){return e/=n,-i*(--e*e*e*e-1)+t}function i(e,t){var i={};return Object.keys(e).forEach((function(t){i[t]=e[t]})),Object.keys(t).forEach((function(e){i[e]=t[e]})),i}function n(e){return e instanceof HTMLElement?e.scrollTop:e.pageYOffset}function a(){var n=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{},a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};this.options=i(e,n),this.easeFunctions=i({easeOutQuart:t},a)}return a.prototype.registerTrigger=function(e,t){var n=this;if(e){var a=e.getAttribute("href")||e.getAttribute("data-target"),o=a&&"#"!==a?document.getElementById(a.substring(1)):document.body,r=i(this.options,function(e,t){var i={};return Object.keys(t).forEach((function(t){var n=e.getAttribute("data-mt-".concat(t.replace(/([A-Z])/g,(function(e){return"-"+e.toLowerCase()}))));n&&(i[t]=isNaN(n)?n:parseInt(n,10))})),i}(e,this.options));"function"==typeof t&&(r.callback=t);var s=function(e){e.preventDefault(),n.move(o,r)};return e.addEventListener("click",s,!1),function(){return e.removeEventListener("click",s,!1)}}},a.prototype.move=function(e){var t=this,a=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};if(0===e||e){a=i(this.options,a);var o,r="number"==typeof e?e:e.getBoundingClientRect().top,s=n(a.container),l=null;r-=a.tolerance;var c=function i(c){var u=n(t.options.container);l||(l=c-1);var d=c-l;if(o&&(r>0&&o>u||r<0&&o<u))return a.callback(e);o=u;var f=t.easeFunctions[a.easing](d,s,r,a.duration);a.container.scroll(0,f),d<a.duration?window.requestAnimationFrame(i):(a.container.scroll(0,r+s),a.callback(e))};window.requestAnimationFrame(c)}},a.prototype.addEaseFunction=function(e,t){this.easeFunctions[e]=t},a}();e.exports=n},"./js/main.js":
/*!********************!*\
  !*** ./js/main.js ***!
  \********************/
/*! no exports provided */function(e,t,i){"use strict";i.r(t);var n=i(/*! ./utils/ios-vh-fix */"./js/utils/ios-vh-fix.js"),a=i(/*! ./modules/modals/init-modals */"./js/modules/modals/init-modals.js"),o=i(/*! ./modules/scroll-smooth */"./js/modules/scroll-smooth.js"),r=i(/*! ./modules/about */"./js/modules/about.js"),s=i(/*! ./modules/modal-feedback */"./js/modules/modal-feedback.js"),l=i(/*! ./modules/according-footer */"./js/modules/according-footer.js"),c=i(/*! ./modules/mask-tel */"./js/modules/mask-tel.js");window.addEventListener("DOMContentLoaded",(function(){Object(n.iosVhFix)(),Object(o.scrollSmooth)(),Object(c.setMaskTel)(),window.addEventListener("load",(function(){Object(a.initModals)(),Object(r.showText)(),Object(r.hideText)(),Object(l.showMenu)(),Object(l.showContacts)(),Object(s.setFocus)()}))}))},"./js/modules/about.js":
/*!*****************************!*\
  !*** ./js/modules/about.js ***!
  \*****************************/
/*! exports provided: showText, hideText */function(e,t,i){"use strict";i.r(t),i.d(t,"showText",(function(){return r})),i.d(t,"hideText",(function(){return s}));var n=document.querySelector(".about__button--opened"),a=document.querySelector(".about__button--closed"),o=document.querySelector(".about__inner-text");function r(){n.addEventListener("click",(function(){n.style.display="none",a.style.display="block",o.classList.contains("about__inner-text--opened")||o.classList.add("about__inner-text--opened")}))}function s(){a.addEventListener("click",(function(){n.style.display="block",a.style.display="none",o.classList.contains("about__inner-text--opened")&&o.classList.remove("about__inner-text--opened")}))}},"./js/modules/according-footer.js":
/*!****************************************!*\
  !*** ./js/modules/according-footer.js ***!
  \****************************************/
/*! exports provided: showMenu, showContacts */function(e,t,i){"use strict";i.r(t),i.d(t,"showMenu",(function(){return l})),i.d(t,"showContacts",(function(){return c}));var n=document.querySelector(".navigation__title"),a=document.querySelector(".main-nav"),o=document.querySelector(".navigation"),r=document.querySelector(".contacts__title"),s=document.querySelector(".contacts");function l(){o.classList.remove("navigation--no-js"),n.addEventListener("click",(function(){a.classList.contains("is-open")?(a.classList.remove("is-open"),o.classList.remove("is-active")):(a.classList.add("is-open"),o.classList.add("is-active"),s.classList.remove("is-open"),s.classList.remove("is-active"))}))}function c(){s.classList.remove("contacts--no-js"),r.addEventListener("click",(function(){s.classList.contains("is-open")?(s.classList.remove("is-open"),s.classList.remove("is-active")):(s.classList.add("is-open"),s.classList.add("is-active"),a.classList.remove("is-open"),o.classList.remove("is-active"))}))}},"./js/modules/mask-tel.js":
/*!********************************!*\
  !*** ./js/modules/mask-tel.js ***!
  \********************************/
/*! exports provided: setMaskTel */function(e,t,i){"use strict";i.r(t),i.d(t,"setMaskTel",(function(){return o}));var n=i(/*! inputmask */"../node_modules/inputmask/dist/inputmask.js"),a=i.n(n);function o(){new a.a({mask:"+7(999) 999-99-99"}).mask(document.querySelectorAll("[data-phone-pattern]"))}},"./js/modules/modal-feedback.js":
/*!**************************************!*\
  !*** ./js/modules/modal-feedback.js ***!
  \**************************************/
/*! exports provided: setFocus */function(e,t,i){"use strict";i.r(t),i.d(t,"setFocus",(function(){return o}));var n=document.querySelector("[data-user-name]"),a=document.querySelector(".page-header__info-button");function o(){a.addEventListener("click",(function(){setTimeout((function(){n.focus()}),100)}))}},"./js/modules/modals/init-modals.js":
/*!******************************************!*\
